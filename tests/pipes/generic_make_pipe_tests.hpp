...
#ifndef FUNKYPIPES_TESTS_PIPES_GENERIC_MAKE_PIPE_TESTS_HPP
#define FUNKYPIPES_TESTS_PIPES_GENERIC_MAKE_PIPE_TESTS_HPP
...
#endif  // FUNKYPIPES_TESTS_PIPES_GENERIC_MAKE_PIPE_TESTS_HPP
