...
static_assert(std::is_same_v<decltype(shiftIndexSequence<1>(std::index_sequence<1>{})), std::index_sequence<2>>);
static_assert(std::is_same_v<decltype(shiftIndexSequence<2>(std::index_sequence<0, 1>{})), std::index_sequence<2, 3>>);
static_assert(std::is_same_v<decltype(shiftIndexSequence<0>(std::index_sequence<0>{})), std::index_sequence<0>>);
static_assert(std::is_same_v<decltype(shiftIndexSequence<3>(std::index_sequence<>{})), std::index_sequence<>>);
