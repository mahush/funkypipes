...
// Implementation of separating the specified elements of a given tuple into two tuples, one the contains the separated
// elements and another containing the rest.
...
auto separateTupleElements(TTuple&& tuple) {
  ...
  // Note: Moving the tuple twice is intended and not an issue, as recreateTupleFromIndices does only modify the
